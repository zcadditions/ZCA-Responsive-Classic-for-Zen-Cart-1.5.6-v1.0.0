...
<?php if (!empty($totalsDisplay)) { ?>
  <div class="cartTotalsDisplay important centeredContent bold"><?php echo $totalsDisplay; ?></div>
  <br class="clearBoth" />
<?php } ?>
...
<a href="<?php echo $product['linkProductsName']; ?>"><span class="cartImage back pad-2"><?php echo $product['productsImage']; ?></span><span class="cartProdTitle"><?php echo $product['productsName'] . '<span class="alert bold">' . $product['flagStockCheck'] . '</span>'; ?></span></a>
<br class="clearBoth" />
...
?>
           <a href="<?php echo zen_href_link(FILENAME_SHOPPING_CART, 'action=remove_product&product_id=' . $product['id']); ?>" role="button"><i class="fas fa-trash-alt"></i></a>
<?php
  }
...
<div id="cartSubTotal" class="text-align-right pady-3 bold border-bottom"><?php echo SUB_TITLE_SUB_TOTAL; ?> <?php echo $cartShowTotal; ?></div>
<br class="clearBoth" />
...
?>
<div class="buttonRow back"><button type="submit" role="button"><i class="fas fa-sync-alt"></i></button></div>
<?php
