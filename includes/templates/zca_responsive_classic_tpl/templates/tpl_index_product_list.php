...
?>
<div id="categoryImgListing" class="categoryImg pad-3"><?php echo zen_image(DIR_WS_IMAGES . $categories_image, '', CATEGORY_ICON_IMAGE_WIDTH, CATEGORY_ICON_IMAGE_HEIGHT); ?></div>
<?php
  }
} // categories_image
?>
...
<div class="indexProductListFilerWrapper">
<?php
...
<?php
  ...
  echo $form;
    ...
    echo '<div class="columns3 pad-2">' .TEXT_SHOW . '</div>';
