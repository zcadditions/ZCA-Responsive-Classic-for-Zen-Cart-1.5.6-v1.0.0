...
<!--bof Product Name-->
<h1 id="productName" class="productGeneral centeredContent"><?php echo $products_name; ?></h1>
<!--eof Product Name-->

<div class="layout">
    
    <div class="columns6 pad-2">
 ...
 */
 if (ZCA_PHOTOSWIPE_STATUS == 'true') {
   require($template->get_template_dir('/tpl_modules_zca_photoswipe_image.php',DIR_WS_TEMPLATE, $current_page_base,'templates'). '/tpl_modules_zca_photoswipe_image.php');
 	} else {
...
<h2 id="productPrices" class="productGeneral centeredContent pad-2">
<?php
// base price
...
?>
  ...
  <?php if ($display_qty != '' or $display_button != '') { ?>
    <div id="cartAdd" class="border pad-2 text-align-center">
    <?php
      echo $display_qty;
      echo $display_button;
            ?>
