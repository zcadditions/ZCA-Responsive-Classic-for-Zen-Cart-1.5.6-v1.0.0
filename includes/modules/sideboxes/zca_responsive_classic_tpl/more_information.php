...
// test if links should display
  if (DEFINE_PAGE_2_STATUS <= 1) {
    $more_information[] = '<a href="' . zen_href_link(FILENAME_PAGE_2) . '"><li class="list-group-item">' . BOX_INFORMATION_PAGE_2 . '</li></a>';
  }
  if (DEFINE_PAGE_3_STATUS <= 1) {
    $more_information[] = '<a href="' . zen_href_link(FILENAME_PAGE_3) . '"><li class="list-group-item">' . BOX_INFORMATION_PAGE_3 . '</li></a>';
  }
  if (DEFINE_PAGE_4_STATUS <= 1) {
    $more_information[] = '<a href="' . zen_href_link(FILENAME_PAGE_4) . '"><li class="list-group-item">' . BOX_INFORMATION_PAGE_4 . '</li></a>';
  }
