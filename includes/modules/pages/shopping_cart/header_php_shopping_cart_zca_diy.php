...
$productArray[$i]['buttonUpdate'] = preg_replace('/(<input type="image".*?\/>)(.*)/', '<button type="submit" role="button"><i class="fas fa-sync-alt"></i></button>$2', $productArray[$i]['buttonUpdate']);  
}